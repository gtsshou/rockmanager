...
function updateChart(rock, dataPoints, minWavelength, maxWavelength, minReflectance, maxReflectance) {
    ...
    try {
        ...
        const option = {
            title: {
                text: `${rock.id || rock.sample_id} - ${rock.lithology || rock.rock_type}`,
            ...
            tooltip: {
                ...
                formatter: function(params) {
                    ...
                    return `
                        <div style="font-weight: bold; margin-bottom: 5px;">${rock.id || rock.sample_id}</div>
...
function compareSpectra() {
    ...
    try {
        ...
        compareList.forEach((rockId, index) => {
            ...
            // 创建系列
            series.push({
                name: data.rock.id || data.rock.sample_id,
                type: 'line',
            ...
            legendData.push(data.rock.id || data.rock.sample_id);
        });
